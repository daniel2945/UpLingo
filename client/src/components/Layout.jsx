...
export const Navbar = () => {
  ...
  const currentLangObj = LANGUAGES.find(l => l.code === learningLang) || LANGUAGES[0];
  ...
  return (
    <nav className="bg-white border-b-2 border-gray-100 px-6 py-4 flex flex-col md:flex-row justify-between items-center sticky top-0 z-10 w-full gap-4 md:gap-0">
      ...
      <div className="flex items-center gap-6 w-full md:w-auto justify-between md:justify-start">
        ...
        <div className="hidden md:flex items-center gap-2 border-l-2 border-slate-100 pl-6 ml-2" dir="rtl">
      ...
      <div className="flex items-center gap-3 w-full md:w-auto justify-between md:justify-end">
        ...
        <div className="flex items-center bg-slate-50 border-2 border-slate-200 rounded-xl px-3 py-1.5 focus-within:border-primary transition-colors">
          <span className="text-xl mr-2 leading-none" role="img" aria-label="flag">
      ...
      <div className="flex md:hidden w-full items-center justify-center gap-2 pt-2 border-t border-slate-100" dir="rtl">
        <NavButton path="/dashboard" icon={Map} label="שיעורים" />
        <NavButton path="/practice" icon={Box} label="ארגז חול" />
      </div>
