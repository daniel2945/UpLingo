...
const { generateMissionDraft, publishMission } = require('../controllers/adminMission');
...
adminRouter.get('/admin/missions/next-order', verifyToken, verifyAdmin, deleteRule);
